    ...
    <footer style={{ backgroundColor: "rgb(250, 250, 250)" }}>
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col">
            <img src="media/images/logost.jpeg" style={{ width: "50%" }} />
            <p>
              &copy; 2010 - 2024, Not Stackfin Broking Ltd. All rights reserved.
          ...
          <div className="col">
            ...
            <br />
            <br />
            <a href=""style={{ textDecoration: "none" }}>Stackfin.tech</a>
            <br />
            <br />
            <a href=""style={{ textDecoration: "none" }}>Press & media</a>
            <br />
            <br />
            <a href=""style={{ textDecoration: "none" }}>Stackfin cares (CSR)</a>
            <br />
            <br />
          </div>
          <div className="col">
            ...
            <br />
            <br />
            <a href=""style={{ textDecoration: "none" }}>S-Connect blog</a>
            <br />
            <br />
        ...
        <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
          <p>
            Stackfin Broking Ltd.: Member of NSE​ &​ BSE – SEBI Registration no.:
            INZ000031633 CDSL: Depository services through Zerodha Securities
            Pvt. Ltd. – SEBI Registration no.: IN-DP-100-2015 Commodity Trading
            through Zerodha Commodities Pvt. Ltd. MCX: 46025 – SEBI Registration
            no.: INZ000038238 Registered Address: Stackfin Broking Ltd.,
